...
window.directTo = function(loanType) {
    ...
    if (loanType === 'degreeProgram') {
        ...
        chatBoxInstance.loanType = 'business';
        chatBoxInstance.mode = 'calculator'; // Ensure we're in calculator mode to handle parameters
        chatBoxInstance.promptForBusinessParameters(); // Directly prompt for business parameters
    } else {
        console.log('Handling for ' + loanType + ' goes here.');
    }
};
